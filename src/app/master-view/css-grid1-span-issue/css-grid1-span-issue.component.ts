...
@Component({
  selector: 'app-css-grid1-span-issue',
  standalone: true,
  ...
  templateUrl: './css-grid1-span-issue.component.html',
  styleUrls: ['./css-grid1-span-issue.component.scss']
})
export class CSSGrid1SpanIssueComponent {}
