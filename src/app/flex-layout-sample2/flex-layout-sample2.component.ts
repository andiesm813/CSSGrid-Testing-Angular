...
@Component({
  selector: 'app-flex-layout-sample2',
  standalone: true,
  ...
  templateUrl: './flex-layout-sample2.component.html',
  styleUrls: ['./flex-layout-sample2.component.scss']
})
export class FlexLayoutSample2Component {}
